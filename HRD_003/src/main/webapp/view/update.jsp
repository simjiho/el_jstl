	...
	<form action="updateProc.jsp" name="frm">
		<table>
			<tr>
				<td>회원아이디(수정불가)</td>
				<td>
					<input type="text" name="userid" id="userid" value="<%=vo.getUserid() %>" readonly="readonly">
				</td>
			</tr>
			<tr>
				<td>이름</td>
				<td>
					<input type="text" name="username" id="username" value="<%=vo.getUsername() %>">
				</td>
			</tr>
			<tr>
				<td>비밀번호</td>
				<td>
					<input type="password" name="passwd" id="passwd" value="<%=vo.getPasswd() %>">
				</td>
			</tr>
			<tr>
				<td>비밀번호확인</td>
			...
			<tr>
				<td>주소</td>
				<td>
					<input type="text" name="address" size="40" id="address" value="<%=vo.getAddress() %>">
				</td>
			</tr>
			<tr>
				<td>직업</td>
			...
			<tr>
				<td>메일수신여부</td>
				<td>
					동의함 <input type="checkbox" name="mailrcv" id="mailrcv" <%=vo.getMailrcv().equals("Y")?"checked":"" %>>
				</td>
			</tr>
			<tr>
				<td>자기소개</td>
				<td>
					<textarea rows="4" cols="40" name="intro" id="intro"><%=vo.getIntro() %></textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2">
